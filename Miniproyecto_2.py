...
# Inicializamos el dispositivo dht con el pin de datos conectado al pin GPIO 23 de la Raspberry Pi:
...
while True:
    try:
        ...
        # Creamos descripción del texto.
        texto = "Temperatura: {:.1f} C    Humedad: {}%".format(Temperatura_c, Humedad)

        # Registramos el texto en el archivo de log
        logging.info("{} - {}".format(Tiempo, texto))

    except RuntimeError as error:
        # Registramos el mensaje de error en el archivo de log
